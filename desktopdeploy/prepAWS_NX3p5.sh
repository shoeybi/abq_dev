...
sudo -E apt-get -y install scrot;
## download and install NX
if [ ! -d "$downloadDir" ]; then 
    mkdir $downloadDir ;
fi
cd $downloadDir ;
#if [ ! -e nxserver_4.0.181-10_amd64.deb ]; then
#    wget http://64.34.173.142/download/4.0/Linux/S/nxserver_4.0.181-10_amd64.deb ;
#fi
#if [ ! -d /usr/NX ]; then
#    sudo dpkg -i nxserver_4.0.181-10_amd64.deb ;
